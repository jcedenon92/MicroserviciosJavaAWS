package com.aforo255.appgateway.filters;
...
public class JwtAuthenticationFilter extends AbstractGatewayFilterFactory<JwtAuthenticationFilter.Config> {
    ...
    /**
     * IMPORTANDO LA CONFIGURACION Y ASIGNANDO A VARIABLE secret
     */
    @Value("${jwt.secret}")
    private String secret;
 
    /**
     *  REESCRIBIENDO EL METODO FILTER 
     *  SE LE PASA CONFIGURACION (Config config) 
     */    
    @Override
